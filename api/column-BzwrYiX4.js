...
| 新闻联播             | 新闻周刊             | 天下足球             |
| -------------------- | -------------------- | -------------------- |
| TOPC1451528971114112 | TOPC1451559180488841 | TOPC1451551777876756 |`};async function s(t){let o=t.req.param(`column`),s=isNaN(Number.parseInt(t.req.query(`limit`)))?25:Number.parseInt(t.req.query(`limit`)),c=await i({method:`get`,url:`https://api.cntv.cn/NewVideo/getVideoListByColumn?id=${o}&n=${s}&sort=desc&p=1&mode=0&serviceId=tvcctv`}),l=c.data.data.list,u=l[0].title.match(/《(.*?)》/)[1];return{title:`CNTV 栏目 - ${u}`,description:`${u} 栏目的视频更新`,item:l.map(t=>({title:t.title,description:n(a.join(e,`templates/column-4b5da82e.art`),{item:t}),pubDate:r(t.time),link:t.url}))}}export{o as route};