import"./esm-shims-CGUM9TC6.js";import"./config-C9m9eBw5.js";import"./logger-CC3afzWM.js";import"./parse-date-D4osZfpm.js";import"./dist-0j_z2rfc.js";import"./helpers-nWIDkd0K.js";import{cache_default as e}from"./cache-GwMhal7i.js";import"./render-DOz85fGU.js";import"./ofetch-ZUQ1sEMc.js";import"./got-CB83B8oA.js";import{invalid_parameter_default as t}from"./invalid-parameter-CUJdROXf.js";import{rss_parser_default as n}from"./rss-parser-CLRsacVu.js";import{getArchive as r,getCategories as i,parseItem as a,parseList as o}from"./utils-gl9EcF6t.js";const s={path:`/news/:region/:category?`,categories:[`new-media`],example:`/yahoo/news/hk/world`,parameters:{region:"Region, `hk/tw/au/ca/fr/malaysia/nz/sg/uk/en(us)`, the part represented by the asterisk (*) in *.news.yahoo.com",category:`Category, The part represented by the asterisk (*) in .news.yahoo.com/rss/*, region "hk/tw" differs, see the description below`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`news.yahoo.com/`]}],name:`News`,maintainers:[`KeiLongW`,`williamgateszhao`],handler:c,url:`news.yahoo.com/`,description:`
\`Region\`
