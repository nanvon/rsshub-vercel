import{__dirname as e,init_esm_shims as t}from"./esm-shims-DtWyl6zt.js";import"./config-BpwDbAkH.js";import"./logger-B3QfaIfn.js";import"./dist-CKN2M7CD.js";import"./helpers-DzX-lcQO.js";import{cache_default as n}from"./cache-BWStd97H.js";import{art as r}from"./render-CxhTJIsl.js";import{parseDate as i}from"./parse-date-Bgabdhlb.js";import"./ofetch-CYKAhM9L.js";import{got_default as a}from"./got-pWlL3EH4.js";import{timezone as o}from"./timezone-BrNu6iXe.js";import s from"node:path";import{load as c}from"cheerio";t();const l=async t=>{let{category:l=`zx/zxfb/`}=t.req.param(),u=t.req.query(`limit`)?Number.parseInt(t.req.query(`limit`),10):10,d=`http://www.agri.cn`,f=new URL(l.endsWith(`/`)?l:`${l}/`,d).href,{data:p}=await a(f),m=c(p),h=m(`html`).prop(`lang`),g=m(`div.list_li_con, div.nxw_video_com`).slice(0,u).toArray().map(t=>{t=m(t);let n=t.find(`a`).first(),a=n.text(),o=t.find(`img`).first().prop(`src`)?new URL(t.find(`img`).first().prop(`src`),d).href:void 0,c=r(s.join(e,`templates/description-881baa33.art`),{intro:t.find(`p.con_text`).text()||void 0,images:o?[{src:o,alt:a}]:void 0});return{title:a,description:c,pubDate:i(t.find(`span.con_date_span`).text()||`${t.find(`div.com_time_p2`).text().trim()}${t.find(`div.com_time_p1`).text()}`,[`YYYY-MM-DD`,`YYYY.MM.DD`]),link:new URL(n.prop(`href`),f).href,content:{html:c,text:t.find(`p.con_text`).text()||void 0},image:o,banner:o,language:h}});g=await Promise.all(g.map(t=>n.tryGet(t.link,async()=>{let{data:n}=await a(t.link),l=c(n),u=l(`div.detailCon_info_tit`).text().trim(),d=r(s.join(e,`templates/description-881baa33.art`),{description:l(`div.content_body_box`).html()});return t.title=u,t.description=d,t.pubDate=o(i(l(`meta[name="publishdate"]`).prop(`content`)),8),t.author=l(`meta[name="author"]`).prop(`content`)||l(`meta[name="source"]`).prop(`content`),t.content={html:d,text:l(`div.content_body_box`).text()},t.language=h,t.enclosure_url=l(`div.content_body_box video`).prop(`src`)??void 0,t.enclosure_type=t.enclosure_url?`video/mp4`:void 0,t.enclosure_title=t.enclosure_url?u:void 0,t})));let _=new URL(m(`div.logo img`).prop(`src`),d).href;return{title:m(`title`).text(),link:f,item:g,allowEmpty:!0,image:_,language:h}},u={path:`/:category{.+}?`,name:`分类`,url:`www.agri.cn`,maintainers:[`nczitzk`],handler:l,example:`/agri/zx/zxfb`,parameters:{category:"分类，默认为 `zx/zxfb`，即最新发布，可在对应分类页 URL 中找到"},description:`::: tip
