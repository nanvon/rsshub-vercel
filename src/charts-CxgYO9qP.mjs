import"./esm-shims-D5mxTuu_.mjs";import{t as e}from"./config-CDM38Tpk.mjs";import"./logger-B0B1yUZ6.mjs";import{t}from"./ofetch-FkpIOIxH.mjs";import{t as n}from"./cache-C6z2tE2n.mjs";import"./render-D2i47mnC.mjs";import"./parse-date-Cv8vEJfE.mjs";import"./not-found-Czrg4Yhr.mjs";import{i as r}from"./utils-CySF6Nek.mjs";const i={path:`/charts/:category?/:country?/:embed?`,categories:[`social-media`],example:`/youtube/charts`,parameters:{category:"Chart, see table below, default to `TopVideos`",country:`Country Code, see table below, default to global`,embed:`Default to embed the video, set to any value to disable embedding`},name:`Music Charts`,maintainers:[`TonyRL`],handler:a,description:`Chart
