import{n as e,t}from"./esm-shims-BKVRry6h.mjs";import{t as n}from"./ofetch-BRplXtiZ.mjs";import"./config-D7dgKYF5.mjs";import"./logger-CkUWGGaS.mjs";import{t as r}from"./cache-Bv3_kFbE.mjs";import{t as i}from"./parse-date-_GmTZfjS.mjs";import{t as a}from"./render-CSqLtqb8.mjs";import{t as o}from"./types-CaC5w-Pp.mjs";import s from"node:path";import c from"node:crypto";e();const l={path:`/:user/:type?`,categories:[`design`],view:o.Pictures,example:`/behance/mishapetrick`,parameters:{user:`username`,type:{description:`type`,options:[{value:`projects`,label:`projects`},{value:`appreciated`,label:`appreciated`}],default:`projects`}},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`User Works`,maintainers:[`MisteryMonster`],handler:d,description:"Behance user's profile URL, like [https://www.behance.net/mishapetrick](https://www.behance.net/mishapetrick) the username will be `mishapetrick`。"},u=async(e,t)=>await r.tryGet(`behance:profile:${t}`,()=>{let n=e.flatMap(e=>e.owners).find(e=>e.username===t);return Promise.resolve({displayName:n.displayName,id:n.id,link:n.url,image:n.images.size_50.url.replace(`/user/50/`,`/user/source/`)})});async function d(e){let{user:o,type:l=`projects`}=e.req.param(),d=c.randomUUID(),f={Cookie:`gk_suid=${Math.random().toString().slice(2,10)}, gki=; originalReferrer=; bcp=${d}`,"X-BCP":d,"X-Requested-With":`XMLHttpRequest`},p=await n(`https://www.behance.net/v3/graphql`,{method:`POST`,headers:f,body:{query:l===`projects`?`query GetProfileProjectsAndSections($username: String, $after: String) {
  ...
  }`,variables:{projectId:e.projectId}}})).data.project;return e.description=a(s.join(t,`templates/description-69dc492c.art`),{description:r.description,modules:r.allModules}),e.category=[...new Set([...e.category||[],...r.tags?.map(e=>e.title.toLowerCase())||[]])],e.pubDate=e.pubDate||(r.publishedOn?i(r.publishedOn,`X`):void 0),e})));return{title:`${g.displayName}'s ${l}`,link:`https://www.behance.net/${o}/${l}`,image:g.image,item:_}}export{l as route};