import"./esm-shims-CGUM9TC6.js";import"./config-C9m9eBw5.js";import"./logger-CC3afzWM.js";import{parseDate as e}from"./parse-date-D4osZfpm.js";import"./dist-0j_z2rfc.js";import"./helpers-nWIDkd0K.js";import{cache_default as t}from"./cache-GwMhal7i.js";import"./ofetch-ZUQ1sEMc.js";import{got_default as n}from"./got-CB83B8oA.js";import{load as r}from"cheerio";const i=async i=>{let{category:a=`xiehuidongtai/xiehuitongzhi`}=i.req.param(),o=i.req.query(`limit`)?Number.parseInt(i.req.query(`limit`),10):25,s=`https://www.chinania.org.cn`,c=new URL(`html/${a.endsWith(`/`)?a:`${a}/`}`,s).href,{data:l}=await n(c),u=r(l),d=u(`html`).prop(`lang`),f=u(`ul.notice_list_ul li`).slice(0,o).toArray().map(t=>(t=u(t),{title:t.find(`p`).first().text(),pubDate:e(t.find(`p`).last().text()),link:t.find(`a`).prop(`href`),language:d}));f=await Promise.all(f.map(i=>t.tryGet(i.link,async()=>{let{data:t}=await n(i.link),a=r(t),o=a(`div.article_title p`).first().text(),s=a(`div.article_content`).html();return i.title=o,i.description=s,i.pubDate=e(a(`div.article_title p`).last().text().split(`：`)),i.author=a(`meta[name='keywords']`).prop(`content`),i.content={html:s,text:a(`div.article_content`).text()},i.language=d,i})));let p=u(`title`).text(),m=new URL(u(`img.logo`).prop(`src`),s).href;return{title:p,description:p.split(/-/)[0]?.trim(),link:c,item:f,allowEmpty:!0,image:m,author:u(`meta[name='keywords']`).prop(`content`),language:d}},a={path:`/:category{.+}?`,name:`分类`,url:`www.chinania.org.cn`,maintainers:[`nczitzk`],handler:i,example:`/chinania/xiehuidongtai/xiehuitongzhi`,parameters:{category:"分类，默认为 `xiehuidongtai/xiehuitongzhi`，即协会通知，可在对应分类页 URL 中找到"},description:`::: tip
