import{__dirname as e,init_esm_shims as t}from"./esm-shims-CGUM9TC6.js";import"./config-C9m9eBw5.js";import"./logger-CC3afzWM.js";import{parseDate as n}from"./parse-date-D4osZfpm.js";import"./dist-0j_z2rfc.js";import{cache_default as r}from"./cache-GwMhal7i.js";import{art as i}from"./render-DOz85fGU.js";import{ofetch_default as a}from"./ofetch-ZUQ1sEMc.js";import{ViewType as o}from"./types-A5bA50Mg.js";import s from"node:path";import c from"node:crypto";t();const l={path:`/:user/:type?`,categories:[`design`],view:o.Pictures,example:`/behance/mishapetrick`,parameters:{user:`username`,type:{description:`type`,options:[{value:`projects`,label:`projects`},{value:`appreciated`,label:`appreciated`}],default:`projects`}},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`User Works`,maintainers:[`MisteryMonster`],handler:d,description:"Behance user's profile URL, like [https://www.behance.net/mishapetrick](https://www.behance.net/mishapetrick) the username will be `mishapetrick`。"},u=async(e,t)=>await r.tryGet(`behance:profile:${t}`,()=>{let n=e.flatMap(e=>e.owners).find(e=>e.username===t);return Promise.resolve({displayName:n.displayName,id:n.id,link:n.url,image:n.images.size_50.url.replace(`/user/50/`,`/user/source/`)})});async function d(t){let{user:o,type:l=`projects`}=t.req.param(),d=c.randomUUID(),f={Cookie:`gk_suid=${Math.random().toString().slice(2,10)}, gki=; originalReferrer=; bcp=${d}`,"X-BCP":d,"X-Requested-With":`XMLHttpRequest`},p=await a(`https://www.behance.net/v3/graphql`,{method:`POST`,headers:f,body:{query:l===`projects`?`query GetProfileProjectsAndSections($username: String, $after: String) {
  ...
  }`,variables:{projectId:t.projectId}}}),o=r.data.project;return t.description=i(s.join(e,`templates/description-69dc492c.art`),{description:o.description,modules:o.allModules}),t.category=[...new Set([...t.category||[],...o.tags?.map(e=>e.title.toLowerCase())||[]])],t.pubDate=t.pubDate||(o.publishedOn?n(o.publishedOn,`X`):void 0),t})));return{title:`${g.displayName}'s ${l}`,link:`https://www.behance.net/${o}/${l}`,image:g.image,item:_}}export{l as route};