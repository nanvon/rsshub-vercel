import"./ofetch-BRplXtiZ.mjs";import"./config-D7dgKYF5.mjs";import"./logger-CkUWGGaS.mjs";import{t as e}from"./cache-Bv3_kFbE.mjs";import"./helpers-Tm7Pw8Vq.mjs";import{t}from"./parse-date-_GmTZfjS.mjs";import{t as n}from"./got-BglkE51W.mjs";import{t as r}from"./timezone-BAp4uBjD.mjs";import{load as i}from"cheerio";import a from"iconv-lite";const o=e=>{let t=/charset="?'?gb/i.test(e.toString())?`gbk`:`utf-8`;return a.decode(e,t)},s={path:`/:category{.+}?`,name:`栏目`,parameters:{category:`分类，见下表，默认为首页`},maintainers:[`nczitzk`],description:`| 要闻 | 公司 | 市场 | 基金 |
| ---- | ---- | ---- | ---- |
| xwzx | ssgs | gppd | tzjj |
