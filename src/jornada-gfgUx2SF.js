import"./esm-shims-Dqvxr0BZ.js";import"./config-BpwDbAkH.js";import"./logger-B3QfaIfn.js";import"./dist-BYIKqG8W.js";import"./helpers-DzX-lcQO.js";import{parseDate as e}from"./parse-date-Bgabdhlb.js";import"./ofetch-CSKgrsrO.js";import{got_default as t}from"./got-CtVGR9YK.js";const n=`https://www.jornada.com.mx`,r={capital:`Capital`,cartones:`Cartones`,ciencia:`Ciencia-Y-Tecnologia`,cultura:`Cultura`,deportes:`Deportes`,economia:`Economia`,estados:`Estados`,mundo:`Mundo`,opinion:`Opinion`,politica:`Politica`,sociedad:`Sociedad`},i=()=>{let e=new Date(Date.now()),t=e.getFullYear()+`-`+(`0`+(e.getMonth()+1)).slice(-2)+`-`+(`0`+e.getDate()).slice(-2);return t},a={path:`/:date?/:category?`,categories:[`traditional-media`],example:`/jornada/2022-10-12/capital`,parameters:{date:"Date string, must be in format of `YYYY-MM-DD`. You can get today's news using `today`",category:`Category, refer to the table below`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`News`,maintainers:[`Thealf154`],handler:o,description:`Provides a way to get an specific rss feed by date and category over the official one.
