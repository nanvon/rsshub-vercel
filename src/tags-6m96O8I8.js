import"./esm-shims-CGUM9TC6.js";import"./config-C9m9eBw5.js";import"./logger-CC3afzWM.js";import"./parse-date-D4osZfpm.js";import"./dist-0j_z2rfc.js";import{cache_default as e}from"./cache-GwMhal7i.js";import{ofetch_default as t}from"./ofetch-ZUQ1sEMc.js";import{baseUrl as n,gqlEndpoint as r,parseItem as i}from"./utils-BOCNHyyw.js";import*as a from"cheerio";const o=r=>e.tryGet(`matters:tags:${r}`,async()=>{let e=await t(`${n}/tags/${r}`),i=a.load(e),o=JSON.parse(i(`script#__NEXT_DATA__`).text()),s=Object.entries(o.props.apolloState.data.ROOT_QUERY).find(([e])=>e.startsWith(`node`))?.pop();return s?.id.split(`:`)[1]}),s=async e=>{let{tid:a}=e.req.param(),s=e.req.query(`limit`)?Number.parseInt(e.req.query(`limit`),10):20,c=await o(a),l=await t(r,{method:`POST`,body:{query:`{
                node(input: {id: "${c}"}) {
                  ... on Tag {
                    content
                    description
