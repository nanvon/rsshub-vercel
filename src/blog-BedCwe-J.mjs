import{n as e,t}from"./esm-shims-BKVRry6h.mjs";import"./config-uQhBoCds.mjs";import"./logger-DQf7gybc.mjs";import{t as n}from"./ofetch-7N8fmlQ6.mjs";import{t as r}from"./cache-BXZZTZVV.mjs";import{t as i}from"./render-_fW2cbJz.mjs";import{t as a}from"./parse-date-C2HciIa2.mjs";import{t as o}from"./types-CaC5w-Pp.mjs";import s from"node:path";import{load as c}from"cheerio";e();const l=async e=>{let{lang:o=`en`}=e.req.param(),l=Number.parseInt(e.req.query(`limit`)??`30`,10),u=`https://www.deepl.com`,d=new URL(`${o}/blog`,u).href,f=c(await n(d)),p=f(`html`).attr(`lang`)??o,m=[];return m=f(`h4, h6`).slice(0,l).toArray().map(e=>{let n=f(e).parent().parent(),r=n.find(`h4, h6`).text(),o=n.find(`img`).attr(`src`),c=i(s.join(t,`templates/description-881baa33.art`),{images:o?[{src:o,alt:r}]:void 0,intro:n.find(`p`).text()}),l=n.find(`time`).attr(`datetime`),d=n.attr(`href`),m=n.find(`span.me-6 span`).last().text().split(/,\s/).map(e=>({name:e,url:void 0,avatar:void 0})),h=l;return{title:r,description:c,pubDate:l?a(l):void 0,link:d?new URL(d,u).href:void 0,author:m,content:{html:c,text:c},image:o,banner:o,updated:h?a(h):void 0,language:p}}),m=await Promise.all(m.map(e=>e.link?r.tryGet(e.link,async()=>{let r=c(await n(e.link)),o=r(`h1[data-contentful-field-id="title"]`).text(),l=e.description+i(s.join(t,`templates/description-881baa33.art`),{description:r(`div.my-redesign-3`).html()}),u=r(`time`).first().attr(`datetime`),d=r(`span[data-contentful-field-id="author"] span`).last().text().split(/,\s/).map(e=>({name:e,url:void 0,avatar:void 0})),f=r(`meta[property="og:image"]`).attr(`content`)??r(`picture[data-contentful-field-id="image"] img`).attr(`src`),m=u,h={title:o,description:l,pubDate:u?a(u):e.pubDate,author:d,content:{html:l,text:l},image:f,banner:f,updated:m?a(m):e.updated,language:p};return{...e,...h}}):e)),{title:f(`title`).text(),description:f(`meta[property="og:description"]`).attr(`content`),link:d,item:m,allowEmpty:!0,image:f(`meta[property="og:image"]`).attr(`content`),language:p,id:f(`meta[property="og:url"]`).attr(`content`)}},u=[{label:`Deutsch`,value:`de`},{label:`English`,value:`en`},{label:`Español`,value:`es`},{label:`日本語`,value:`ja`},{label:`Français`,value:`fr`},{label:`Italiano`,value:`it`},{label:`Bahasa Indonesia`,value:`id`},{label:`한국어`,value:`ko`},{label:`Nederlands`,value:`nl`},{label:`Čeština`,value:`cs`},{label:`Svenska`,value:`sv`},{label:`Polski`,value:`pl`},{label:`Português (Brasil)`,value:`pt-BR`},{label:`Português`,value:`pt-PT`},{label:`Türkçe`,value:`tr`},{label:`Русский`,value:`ru`},{label:`简体中文`,value:`zh`},{label:`Українська`,value:`uk`},{label:`العربية`,value:`ar`}],d={path:`/blog/:lang?`,name:`Blog`,url:`www.deepl.com`,maintainers:[`nczitzk`],handler:l,example:`/deepl/blog/en`,parameters:{lang:{description:"Language, `en` as English by default",options:u}},description:`::: tip
