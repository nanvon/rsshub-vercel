import"./esm-shims-B6VgfGYP.js";import"./config-CVBRPN4O.js";import"./logger-BvonkID1.js";import"./ofetch-D4MiciTC.js";import"./helpers-gUVC02jt.js";import{cache_default as e}from"./cache-Dfid4xgQ.js";import"./render-CSnicFA3.js";import"./parse-date-DHsdom8D.js";import{got_default as t}from"./got-07RFwdy7.js";import"./timezone-CMz5pnRe.js";import{ProcessItems as n,rootUrl as r}from"./utils-BmoDw_cy.js";const i={path:`/video/:id?`,categories:[`traditional-media`],example:`/yicai/video`,parameters:{id:`分类 id，见下表，可在对应分类页中找到，默认为视听`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`yicai.com/video/:id`,`yicai.com/video`],target:`/video/:id`}],name:`视听`,maintainers:[`nczitzk`],handler:a,description:`| Id                   | 名称                         |
| -------------------- | ---------------------------- |
| youliao              | 有料                         |
| appshipin            | 此刻                         |
| yicaisudi            | 速递                         |
