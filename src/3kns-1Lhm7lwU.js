import{__dirname as e,init_esm_shims as t}from"./esm-shims-DtWyl6zt.js";import"./config-BpwDbAkH.js";import"./logger-B3QfaIfn.js";import"./dist-CKN2M7CD.js";import"./helpers-DzX-lcQO.js";import{art as n}from"./render-CxhTJIsl.js";import{parseDate as r}from"./parse-date-Bgabdhlb.js";import"./ofetch-CYKAhM9L.js";import{got_default as i}from"./got-pWlL3EH4.js";import a from"node:path";import{load as o}from"cheerio";t();const s={path:`/:filters?/:order?`,categories:[`game`],example:`/3kns/category=all&lang=all`,parameters:{filters:`过滤器，可用参数见下表`,order:`排序，按高分排序:desc;按低分排序:asc`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`3k-Switch游戏库`,maintainers:[`xzzpig`],handler:c,url:`www.3kns.com/`,description:`游戏类型(category)
