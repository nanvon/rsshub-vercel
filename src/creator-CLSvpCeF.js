...
fragment ImageControlIcons_Post on Post {
  ...
  favoritesCount
  ...PostComment_Post
}`,variables:{identifier:e,first:t,after:``},operationName:`CreatorPostReelList`}),method:`POST`});return r.data.posts.nodes}),d={path:`/r18/creator/:identifier`,categories:[`multimedia`],example:`/fantube/r18/creator/miyuu`,parameters:{identifier:`User handle`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`www.fantube.tokyo/r18/creator/:identifier`]}],name:`User Posts`,maintainers:[`TonyRL`],handler:p},f=({description:t,thumbnailUrl:n,sampleVideoId:r,imageUrls:a})=>i(o.join(e,`templates/post-7ca176ac.art`),{description:t,thumbnailUrl:n,sampleVideoId:r,imageUrls:a});async function p(e){let{identifier:t}=e.req.param(),n=Number.parseInt(e.req.query(`limit`)||18,10),r=await l(t),i=await u(t,n),o=i.map(e=>({title:e.title.replaceAll(`
