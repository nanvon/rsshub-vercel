import"./esm-shims-CaZMYoY8.js";import{t as e}from"./config-DZMnNPig.js";import"./logger-asV68Lay.js";import"./ofetch-VsB2Peor.js";import"./helpers-Cqaav28H.js";import{t}from"./parse-date-CHEO0z5G.js";import{t as n}from"./got-BVCqvF6m.js";import{t as r}from"./config-not-found-CX6cWM57.js";import{load as i}from"cheerio";import{JSDOM as a}from"jsdom";const o={path:`/tag/:name?/:type?`,categories:[`social-media`],example:`/lofter/tag/cosplay/date`,parameters:{name:"tag name, such as `名侦探柯南`, `摄影` by default",type:`ranking type, see below, new by default`},features:{requireConfig:[{name:`LOFTER_COOKIE`,description:`LOFTER_COOKIE: 用于搜索标签相关内容，获取方式：
