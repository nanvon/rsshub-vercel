import"./esm-shims-L08rKynx.mjs";import{t as e}from"./config-Bs8nOQqi.mjs";import"./logger-BvLYiR5T.mjs";import{t}from"./ofetch-1TBKTiHL.mjs";import{t as n}from"./cache-BDs-9Wd7.mjs";import"./render-CBhnapAf.mjs";import"./parse-date-bKmkZ9gg.mjs";import"./not-found-CKBbeCyA.mjs";import{i as r}from"./utils-B38rRnGz.mjs";const i={path:`/charts/:category?/:country?/:embed?`,categories:[`social-media`],example:`/youtube/charts`,parameters:{category:"Chart, see table below, default to `TopVideos`",country:`Country Code, see table below, default to global`,embed:`Default to embed the video, set to any value to disable embedding`},name:`Music Charts`,maintainers:[`TonyRL`],handler:a,description:`Chart
