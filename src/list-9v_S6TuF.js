...
| score    | 筛选评分               | 0.0-10.0 | 0      |
  ...
  > 如：小说热门榜的分享链接为：\`https://m.douban.com/subject_collection/ECDIHUN4A\`，其对应本 RSS 路由的 \`type\` 为 \`ECDIHUN4A\`，对应的订阅链接路由：[\`/douban/list/ECDIHUN4A\`](https://rsshub.app/douban/list/ECDIHUN4A)`};async function l(t){let c=t.req.param(`type`)||`subject_real_time_hotest`,l=Object.fromEntries(new URLSearchParams(t.req.param(`routeParams`))),u=i(void 0,o(l.playable),0),d=i(void 0,a(l.score),0),f=0,p=[],m=``,h=``,g=null;for(;g===null||f<g;){let t=await r({method:`get`,url:`https://m.douban.com/rexxar/api/v2/subject_collection/${c}/items?playable=${u}&start=${f}&count=50`,headers:{Referer:`https://m.douban.com/subject_collection/${c}`}});m=t.data.subject_collection.name,h=t.data.subject_collection.description,g=t.data.total;let i=t.data.subject_collection_items.filter(e=>(e.rating?e.rating.value:0)>=d).map(t=>{let r=t.title;return{title:r,link:t.url,description:n(s.join(e,`templates/list_description-833a570f.art`),{ranking_value:t.ranking_value,title:r,original_title:t.original_title,rate:t.rating?t.rating.value:null,card_subtitle:t.card_subtitle,description:t.cards?t.cards[0].content:t.abstract,cover:t.cover_url||t.cover?.url})}});p=[...p,...i],f+=50}return{title:`豆瓣 - ${m}`,link:`https://m.douban.com/subject_collection/${c}`,item:p,description:h}}export{c as route};