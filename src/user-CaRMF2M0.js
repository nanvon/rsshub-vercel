import"./esm-shims-rNwigI-Q.js";import{config as e}from"./config-CVBRPN4O.js";import"./logger-BvonkID1.js";import{ofetch_default as t}from"./ofetch-CeMUzp5K.js";import{cache_default as n}from"./cache-Dfid4xgQ.js";import"./render-DftO2d-b.js";import"./parse-date-DHsdom8D.js";import{baseUrl as r,getBuildId as i,getData as a,getList as o}from"./utils-BG9uzsSD.js";const s={path:`/user/:userId/:innerSharedContent?`,example:`/daily/user/kramer`,radar:[{source:[`app.daily.dev/:userId/posts`,`app.daily.dev/:userId`]}],parameters:{innerSharedContent:{description:`Where to Fetch inner Shared Posts instead of original`,default:`false`,options:[{value:`false`,label:`False`},{value:`true`,label:`True`}]}},name:`User Posts`,maintainers:[`TonyRL`],handler:c,url:`app.daily.dev`};async function c(s){let c=s.req.param(`userId`),l=s.req.query(`limit`)?Number.parseInt(s.req.query(`limit`),10):7,u=s.req.param(`innerSharedContent`)?JSON.parse(s.req.param(`innerSharedContent`)):!1,d=await i(),f=(await n.tryGet(`daily:user:${c}`,async()=>(await t(`${r}/_next/data/${d}/en/${c}.json`,{query:{userId:c}})).pageProps)).user,p=await n.tryGet(`daily:user:${c}:posts`,async()=>o(await a({query:`
  ...
  fragment UserPost on Post {
    ...
    bookmarked
    downvoted
  }`,variables:{userId:f.id,first:l,loggedIn:!1}}),u,!0),e.cache.routeExpire,!1);return{title:`${f.name} | daily.dev`,description:f.bio,link:`${r}/${c}/posts`,item:p,image:f.image,logo:f.image,icon:f.image,language:`en-us`}}export{s as route};