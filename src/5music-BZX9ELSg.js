import"./esm-shims-CaZMYoY8.js";import"./config-DZMnNPig.js";import"./logger-asV68Lay.js";import"./ofetch-VsB2Peor.js";import"./helpers-Cqaav28H.js";import{t as e}from"./parse-date-CHEO0z5G.js";import{t}from"./got-BVCqvF6m.js";import{load as n}from"cheerio";const r={path:`/new-releases/:category?`,categories:[`shopping`],example:`/5music/new-releases`,parameters:{category:`Category, see below, defaults to all`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`www.5music.com.tw/New_releases.asp`,`www.5music.com.tw/`],target:`/new-releases`}],name:`新貨上架`,maintainers:[`gideonsenku`],handler:i,description:`Categories:
| 華語 | 西洋 | 東洋 | 韓語 | 古典 |
| ---- | ---- | ---- | ---- | ---- |
