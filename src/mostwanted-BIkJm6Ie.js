import"./esm-shims-rNwigI-Q.js";import"./config-CVBRPN4O.js";import"./logger-BvonkID1.js";import{ofetch_default as e}from"./ofetch-CeMUzp5K.js";import"./render-DftO2d-b.js";import{ViewType as t}from"./types-Bi82qguM.js";import{baseUrl as n,fetchItems as r}from"./util-crR-s60T.js";import{load as i}from"cheerio";const a=async t=>{let{time:a=`24h`,country:o=`us`}=t.req.param(),s=Number.parseInt(t.req.query(`limit`)??`30`,10),c=new URL(`mostwanted/`,n).href,l=i(await e(c,{headers:{Cookie:`countryId=${o};`}})),u=l(`html`).attr(`lang`)??`en`,d=await r(l,a?`div[id$="-${a}"] div.card-panel`:`div.card-panel`,c,o,s),f=l(`title`).text(),p=l(`ul.tabs li.tab a[href$="-${a}"]`).text();return{title:`${f}${p?` - ${p}`:``}`,description:l(`meta[name="description"]`).attr(`content`),link:c,item:d,allowEmpty:!0,image:l(`a.brand-logo img`).attr(`src`)?new URL(l(`a.brand-logo img`).attr(`src`),n).href:void 0,author:f.split(/\|/).pop(),language:u,id:c}},o={path:`/mostwanted/:time?/:country?`,name:`Watchlist Charts`,url:`app-sales.net`,maintainers:[`nczitzk`],handler:a,example:`/app-sales/mostwanted`,parameters:{time:{description:"Time, `24h` as Last 24h by default",options:[{label:`Last 24h`,value:`24h`},{label:`Last Week`,value:`week`},{label:`All Time`,value:`alltime`}]},country:{description:"Country ID, `us` as United States by default",options:[{label:`United States`,value:`us`},{label:`Austria`,value:`at`},{label:`Australia`,value:`au`},{label:`Brazil`,value:`br`},{label:`Canada`,value:`ca`},{label:`France`,value:`fr`},{label:`Germany`,value:`de`},{label:`India`,value:`in`},{label:`Italy`,value:`it`},{label:`Netherlands`,value:`nl`},{label:`Poland`,value:`pl`},{label:`Russia`,value:`ru`},{label:`Spain`,value:`es`},{label:`Sweden`,value:`se`},{label:`Great Britain`,value:`gb`}]}},description:`
