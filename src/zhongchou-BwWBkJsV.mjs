import"./esm-shims-L08rKynx.mjs";import"./config-L8Ls2W7q.mjs";import"./logger-C50fTRi5.mjs";import"./ofetch-DXVwJZV0.mjs";import"./helpers-mo8InLYm.mjs";import{t as e}from"./cache-ZTWfXd2T.mjs";import{t}from"./got-D6JCV29k.mjs";import{load as n}from"cheerio";const r={path:`/zhongchou/:category?/:sort?/:status?`,categories:[`shopping`],example:`/modian/zhongchou`,parameters:{category:`分类，见下表，默认为全部`,sort:`排序，见下表，默认为最新上线`,status:`状态，见下表，默认为全部`},name:`众筹`,maintainers:[`nczitzk`],description:`分类
