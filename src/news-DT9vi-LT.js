import"./esm-shims-BGJi2y--.js";import"./config-CVBRPN4O.js";import"./logger-BvonkID1.js";import"./ofetch-DqHh1IN2.js";import"./helpers-gUVC02jt.js";import{cache_default as e}from"./cache-Dfid4xgQ.js";import"./render-CSnicFA3.js";import"./parse-date-DHsdom8D.js";import"./got-VGofQtEf.js";import{invalid_parameter_default as t}from"./invalid-parameter-CfUmvEUg.js";import{rss_parser_default as n}from"./rss-parser-PDXVbDgf.js";import{getArchive as r,getCategories as i,parseItem as a,parseList as o}from"./utils-CazcrofS.js";const s={path:`/news/:region/:category?`,categories:[`new-media`],example:`/yahoo/news/hk/world`,parameters:{region:"Region, `hk/tw/au/ca/fr/malaysia/nz/sg/uk/en(us)`, the part represented by the asterisk (*) in *.news.yahoo.com",category:`Category, The part represented by the asterisk (*) in .news.yahoo.com/rss/*, region "hk/tw" differs, see the description below`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`news.yahoo.com/`]}],name:`News`,maintainers:[`KeiLongW`,`williamgateszhao`],handler:c,url:`news.yahoo.com/`,description:`
\`Region\`
