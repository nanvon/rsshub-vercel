import"./esm-shims-CMsyBHYK.js";import"./config-DZMnNPig.js";import"./logger-asV68Lay.js";import"./ofetch-CRUPiVpr.js";import"./helpers-Cqaav28H.js";import{t as e}from"./parse-date-CHEO0z5G.js";import{t}from"./got-BlqYKpVp.js";const n={path:`/:city/:pollution?`,categories:[`other`],example:`/aqicn/beijing/pm25`,parameters:{city:`城市拼音或地区 ID，详见[aqicn.org](http://aqicn.org/city/)`,pollution:`可选择显示更详细的空气污染成分`},radar:[{source:[`aqicn.org`]}],name:`实时 AQI`,maintainers:[`ladeng07`],handler:r,url:`aqicn.org`,descriptions:`
|   参数   | 污染成分 |
| -------- | -------- |
|   pm25   |  PM2.5   |
|   pm10   |  PM10    |
