import{__dirname as e,init_esm_shims as t}from"./esm-shims-B6VgfGYP.js";import"./config-CVBRPN4O.js";import"./logger-BvonkID1.js";import{ofetch_default as n}from"./ofetch-CHIwZNTj.js";import{cache_default as r}from"./cache-Dfid4xgQ.js";import{art as i}from"./render-CSnicFA3.js";import{parseDate as a}from"./parse-date-DHsdom8D.js";import{ViewType as o}from"./types-Bi82qguM.js";import s from"node:path";import{load as c}from"cheerio";t();const l=async t=>{let{lang:o=`en`}=t.req.param(),l=Number.parseInt(t.req.query(`limit`)??`30`,10),u=`https://www.deepl.com`,d=new URL(`${o}/blog`,u).href,f=await n(d),p=c(f),m=p(`html`).attr(`lang`)??o,h=[];return h=p(`h4, h6`).slice(0,l).toArray().map(t=>{let n=p(t).parent().parent(),r=n.find(`h4, h6`).text(),o=n.find(`img`).attr(`src`),c=i(s.join(e,`templates/description-881baa33.art`),{images:o?[{src:o,alt:r}]:void 0,intro:n.find(`p`).text()}),l=n.find(`time`).attr(`datetime`),d=n.attr(`href`),f=n.find(`span.me-6 span`).last().text().split(/,\s/).map(e=>({name:e,url:void 0,avatar:void 0})),h=l;return{title:r,description:c,pubDate:l?a(l):void 0,link:d?new URL(d,u).href:void 0,author:f,content:{html:c,text:c},image:o,banner:o,updated:h?a(h):void 0,language:m}}),h=await Promise.all(h.map(t=>t.link?r.tryGet(t.link,async()=>{let r=await n(t.link),o=c(r),l=o(`h1[data-contentful-field-id="title"]`).text(),u=t.description+i(s.join(e,`templates/description-881baa33.art`),{description:o(`div.my-redesign-3`).html()}),d=o(`time`).first().attr(`datetime`),f=o(`span[data-contentful-field-id="author"] span`).last().text().split(/,\s/).map(e=>({name:e,url:void 0,avatar:void 0})),p=o(`meta[property="og:image"]`).attr(`content`)??o(`picture[data-contentful-field-id="image"] img`).attr(`src`),h=d,g={title:l,description:u,pubDate:d?a(d):t.pubDate,author:f,content:{html:u,text:u},image:p,banner:p,updated:h?a(h):t.updated,language:m};return{...t,...g}}):t)),{title:p(`title`).text(),description:p(`meta[property="og:description"]`).attr(`content`),link:d,item:h,allowEmpty:!0,image:p(`meta[property="og:image"]`).attr(`content`),language:m,id:p(`meta[property="og:url"]`).attr(`content`)}},u=[{label:`Deutsch`,value:`de`},{label:`English`,value:`en`},{label:`Español`,value:`es`},{label:`日本語`,value:`ja`},{label:`Français`,value:`fr`},{label:`Italiano`,value:`it`},{label:`Bahasa Indonesia`,value:`id`},{label:`한국어`,value:`ko`},{label:`Nederlands`,value:`nl`},{label:`Čeština`,value:`cs`},{label:`Svenska`,value:`sv`},{label:`Polski`,value:`pl`},{label:`Português (Brasil)`,value:`pt-BR`},{label:`Português`,value:`pt-PT`},{label:`Türkçe`,value:`tr`},{label:`Русский`,value:`ru`},{label:`简体中文`,value:`zh`},{label:`Українська`,value:`uk`},{label:`العربية`,value:`ar`}],d={path:`/blog/:lang?`,name:`Blog`,url:`www.deepl.com`,maintainers:[`nczitzk`],handler:l,example:`/deepl/blog/en`,parameters:{lang:{description:"Language, `en` as English by default",options:u}},description:`::: tip
