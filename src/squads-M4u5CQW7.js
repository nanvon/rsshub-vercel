...
`,variables:{handle:s}},!0),f=r(await n({query:`
  query SourceFeed(
    $source: ID!
...
`,variables:{...i,source:l,ranking:`TIME`,supportedTypes:[`article`,`share`,`freeform`,`video:youtube`,`collection`,`welcome`],first:a}}),o,!0);return{title:`${d} - daily.dev`,link:c,item:f,description:u,logo:`${t}/favicon-32x32.png`,icon:`${t}/favicon-32x32.png`,language:`en-us`}}export{a as route};