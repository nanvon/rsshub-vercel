import"./esm-shims-Dqvxr0BZ.js";import"./config-BpwDbAkH.js";import"./logger-B3QfaIfn.js";import"./dist-BYIKqG8W.js";import"./cache-BWStd97H.js";import"./parse-date-Bgabdhlb.js";import{ofetch_default as e}from"./ofetch-CSKgrsrO.js";import{ProcessFeed as t,getCategoryBrief as n,parseList as r}from"./utils-J-NN3B0U.js";const i={path:`/trending/:category/:type`,categories:[`programming`],example:`/juejin/trending/ios/monthly`,parameters:{category:`分类名`,type:`类型`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`热门`,maintainers:[`moaix`],handler:a,description:`| category | 标签     |
| -------- | -------- |
| android  | Android  |
| frontend | 前端     |
| ios      | iOS      |
