import"./esm-shims-DhF_MXa4.mjs";import"./config-PItPnVIx.mjs";import"./logger-BoKmWr7Z.mjs";import{t as e}from"./ofetch-DVhBwO41.mjs";import{load as t}from"cheerio";const n=`/wohnnet/`,r=`https://www.wohnnet.at/immobilien/`,i={name:`Immobiliensuche`,path:`/:category/:region/*`,maintainers:[`sk22`],categories:[`other`],description:`
