import{n as e,t}from"./esm-shims-CaZMYoY8.js";import"./config-DZMnNPig.js";import"./logger-asV68Lay.js";import"./ofetch-VsB2Peor.js";import"./helpers-Cqaav28H.js";import{t as n}from"./render-d6AVTUl2.js";import{t as r}from"./parse-date-CHEO0z5G.js";import{t as i}from"./got-BVCqvF6m.js";import a from"node:path";import{load as o}from"cheerio";e();const s=`https://xgzlyhd.samr.gov.cn`,c=new URL(`gjjly/message/getMessageList`,s).href,l=new URL(`gjjly/message/getDataList`,s).href,u=new URL(`gjjly/index`,s).href,d={category:`1`,department:`2`},f=async e=>{let{data:t}=await i.post(l,{json:{type:d[e]}});return t.data},p=async(e,t)=>{let n=(await f(e)).filter(e=>e.name===t||e.code===t);if(n.length>0)return n.pop()},m={path:`/samr/xgzlyhd/:category?/:department?`,categories:[`government`],example:`/gov/samr/xgzlyhd`,parameters:{category:`留言类型，见下表，默认为全部`,department:`回复部门，见下表，默认为全部`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`xgzlyhd.samr.gov.cn/gjjly/index`]}],name:`留言咨询`,maintainers:[`nczitzk`],handler:h,url:`xgzlyhd.samr.gov.cn/gjjly/index`,description:`#### 留言类型
...
| 离退办                       | 6bf265ffd1c94fa4a3f1687b03fa908b |`};async function h(e){let{category:l,department:d}=e.req.param(),f=e.req.query(`limit`)?Number.parseInt(e.req.query(`limit`),10):10,m,h;l&&(m=await p(`category`,l)),d&&(h=await p(`department`,d));let{data:g}=await i.post(c,{json:{clyj:``,curPage:`1`,endTime:``,fzsj:h?.code??``,lybt:void 0,lylx:m?.code??``,lynr:``,startTime:``,zj:``}}),_=g.data.data.slice(0,f).map(e=>({title:e.lybt,link:`${u}#${e.zj}`,description:n(a.join(t,`templates/description-5c2bbb00.art`),{item:e}),author:`${e.lyr} ⇄ ${e.fzsjCn}`,category:[e.fzsjCn],guid:`${u}#${e.zj}`,pubDate:r(e.pubtime)})),{data:v}=await i(u),y=o(v),b=`国家市场监督管理总局`,x=y(`title`).text(),S=[m?m.name:void 0,h?h.name:void 0].filter(Boolean).join(` - `),C=new URL(y(`link[rel="icon"]`).prop(`href`),s).href;return{item:_,title:`${b}${x}${S?` - ${S}`:``}`,link:u,description:y(`meta[property="og:description"]`).prop(`content`),language:`zh`,image:new URL(`gjjly/${y(`div.fd-logo img`).prop(`src`)}`,s).href,icon:C,logo:C,subtitle:S,author:b,allowEmpty:!0}}export{m as route};