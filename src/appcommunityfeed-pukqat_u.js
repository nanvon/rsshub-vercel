...
:::
`,name:`Steam Community Hub Feeds`,maintainers:[`NyaaaDoge`],handler:async t=>{let{appid:o=730,routeParams:s}=t.req.param(),c=`https://steamcommunity.com/library/appcommunityfeed/${o}${s?`?${s}`:``}`,l=await n(c);return{title:`${o} Steam Community Hub`,link:`https://steamcommunity.com/app/${o}`,item:l.hub.map(t=>({title:t.title===``?a[t.type]:t.title,link:`https://steamcommunity.com/sharedfiles/filedetails/?id=${t.published_file_id}`,description:r(i.join(e,`templates/appcommunityfeed-description-b79402f1.art`),{image:t.full_image_url,description:t.description}),author:t.creator.name,category:a[t.type]}))}}};export{o as route};