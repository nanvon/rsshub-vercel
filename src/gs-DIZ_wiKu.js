import"./esm-shims-CGUM9TC6.js";import"./config-C9m9eBw5.js";import"./logger-CC3afzWM.js";import{parseDate as e}from"./parse-date-D4osZfpm.js";import"./dist-0j_z2rfc.js";import"./helpers-nWIDkd0K.js";import{cache_default as t}from"./cache-GwMhal7i.js";import"./ofetch-ZUQ1sEMc.js";import{got_default as n}from"./got-CB83B8oA.js";import{load as r}from"cheerio";const i=async i=>{let{category:a=`xwdt`}=i.req.param(),o=i.req.query(`limit`)?Number.parseInt(i.req.query(`limit`),10):16,s=`https://gs.hust.edu.cn`,c=new URL(`${a}.htm`,s).href,{data:l}=await n(c),u=r(l),d=u(`div.btlist ul li`).slice(0,o).toArray().map(t=>{t=u(t);let n=t.find(`a`),r=n.prop(`href`);return{title:n.text(),pubDate:e(t.find(`span.time`).text()),link:r.startsWith(`http`)?r:new URL(r,s).href}});d=await Promise.all(d.map(e=>t.tryGet(e.link,async()=>{try{let{data:t}=await n(e.link),i=r(t),a=i(`div.v_news_content`).html();e.title=i(`div.article_title h1, h5`).text(),e.description=a,e.content={html:a,text:i(`div.v_news_content`).text()}}catch{}return e})));let f=u(`meta[name="keywords"]`).prop(`content`)?.replace(/,/g,` - `)??u(`title`).text(),p=new URL(u(`div.logo img`).prop(`src`),s).href;return{title:f,description:f.split(/-/).pop()?.trim(),link:c,item:d,allowEmpty:!0,image:p}},a={path:`/gs/:category{.+}?`,name:`研究生院`,url:`gs.hust.edu.cn`,maintainers:[`nczitzk`],handler:i,example:`/hust/gs/xwdt`,parameters:{category:"分类，默认为新闻动态，即 `xwdt`，可在对应分类页 URL 中找到"},description:`::: tip
