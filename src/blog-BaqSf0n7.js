import{__dirname as e,init_esm_shims as t}from"./esm-shims-CGUM9TC6.js";import"./config-C9m9eBw5.js";import"./logger-CC3afzWM.js";import{parseDate as n}from"./parse-date-D4osZfpm.js";import"./dist-0j_z2rfc.js";import{cache_default as r}from"./cache-GwMhal7i.js";import{art as i}from"./render-DOz85fGU.js";import{ofetch_default as a}from"./ofetch-ZUQ1sEMc.js";import{ViewType as o}from"./types-A5bA50Mg.js";import s from"node:path";import{load as c}from"cheerio";t();const l=async t=>{let{lang:o=`en`}=t.req.param(),l=Number.parseInt(t.req.query(`limit`)??`30`,10),u=`https://www.deepl.com`,d=new URL(`${o}/blog`,u).href,f=await a(d),p=c(f),m=p(`html`).attr(`lang`)??o,h=[];return h=p(`h4, h6`).slice(0,l).toArray().map(t=>{let r=p(t).parent().parent(),a=r.find(`h4, h6`).text(),o=r.find(`img`).attr(`src`),c=i(s.join(e,`templates/description-881baa33.art`),{images:o?[{src:o,alt:a}]:void 0,intro:r.find(`p`).text()}),l=r.find(`time`).attr(`datetime`),d=r.attr(`href`),f=r.find(`span.me-6 span`).last().text().split(/,\s/),h=f.map(e=>({name:e,url:void 0,avatar:void 0})),g=l,_={title:a,description:c,pubDate:l?n(l):void 0,link:d?new URL(d,u).href:void 0,author:h,content:{html:c,text:c},image:o,banner:o,updated:g?n(g):void 0,language:m};return _}),h=await Promise.all(h.map(t=>t.link?r.tryGet(t.link,async()=>{let r=await a(t.link),o=c(r),l=o(`h1[data-contentful-field-id="title"]`).text(),u=t.description+i(s.join(e,`templates/description-881baa33.art`),{description:o(`div.my-redesign-3`).html()}),d=o(`time`).first().attr(`datetime`),f=o(`span[data-contentful-field-id="author"] span`).last().text().split(/,\s/),p=f.map(e=>({name:e,url:void 0,avatar:void 0})),h=o(`meta[property="og:image"]`).attr(`content`)??o(`picture[data-contentful-field-id="image"] img`).attr(`src`),g=d,_={title:l,description:u,pubDate:d?n(d):t.pubDate,author:p,content:{html:u,text:u},image:h,banner:h,updated:g?n(g):t.updated,language:m};return{...t,..._}}):t)),{title:p(`title`).text(),description:p(`meta[property="og:description"]`).attr(`content`),link:d,item:h,allowEmpty:!0,image:p(`meta[property="og:image"]`).attr(`content`),language:m,id:p(`meta[property="og:url"]`).attr(`content`)}},u=[{label:`Deutsch`,value:`de`},{label:`English`,value:`en`},{label:`Español`,value:`es`},{label:`日本語`,value:`ja`},{label:`Français`,value:`fr`},{label:`Italiano`,value:`it`},{label:`Bahasa Indonesia`,value:`id`},{label:`한국어`,value:`ko`},{label:`Nederlands`,value:`nl`},{label:`Čeština`,value:`cs`},{label:`Svenska`,value:`sv`},{label:`Polski`,value:`pl`},{label:`Português (Brasil)`,value:`pt-BR`},{label:`Português`,value:`pt-PT`},{label:`Türkçe`,value:`tr`},{label:`Русский`,value:`ru`},{label:`简体中文`,value:`zh`},{label:`Українська`,value:`uk`},{label:`العربية`,value:`ar`}],d={path:`/blog/:lang?`,name:`Blog`,url:`www.deepl.com`,maintainers:[`nczitzk`],handler:l,example:`/deepl/blog/en`,parameters:{lang:{description:"Language, `en` as English by default",options:u}},description:`:::tip
