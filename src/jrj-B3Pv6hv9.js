...
| 603   | 券商资讯 |
| 105   | 观点 |
    `,maintainers:[`p3psi-boo`],handler:o};async function o(a){let o=a.req.param(`channelNum`),s=await n(`https://gateway.jrj.com/jrj-news/news/queryNewsList`,{method:`post`,body:{sortBy:1,pageSize:20,makeDate:``,channelNum:o,infoCls:``}}),c=s.data.data,l=c.map(t=>{let n=t.pcInfoUrl,r=t.title,i=t.paperMediaSource,a=e(t.makeDate);return{title:r,link:n,author:i,pubDate:a}}),u=await Promise.all(l.map(e=>t.tryGet(e.link,async()=>{let t=e.link,i=await n(t),a=r(i),o=a(`.article_content`).html();return e.description=o,e})));return{title:`${i[o]} - 金融界`,link:`https://jrj.com`,item:u}}export{a as route};