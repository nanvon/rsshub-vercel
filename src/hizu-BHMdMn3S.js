...
| 高新     | 607d37ade4b05c59ac2f3d40 |`};async function o(a){let o=a.req.param(`column`)??`5dd92265e4b0bf88dd8c1175`,s=`https://www.hizh.cn`,c=`${s}/channels/zjyapp/columns/${o}/stories.json`,l=await n({method:`get`,url:c}),u=l.data.stories.slice(0,a.req.query(`limit`)?Number.parseInt(a.req.query(`limit`)):50).map(t=>({title:t.title,author:t.author,link:t.jsonUrl,category:t.columnName,pubDate:e(t.published)}));return u=await Promise.all(u.map(e=>t.tryGet(e.link,async()=>{let t=await n({method:`get`,url:e.link}),i=r(t.data.content);return i(`figure`).last().remove(),e.description=i.html(),e.link=`${s}/content.html?jsonUrl=${e.link}`,e}))),{title:`${i[o]} - 珠海网`,link:s,item:u}}export{a as route};