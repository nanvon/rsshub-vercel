import{t as e}from"./ofetch-BRplXtiZ.mjs";import"./config-D7dgKYF5.mjs";import"./logger-CkUWGGaS.mjs";import{t}from"./parse-date-_GmTZfjS.mjs";const n=e=>{let t={};if(!e)return t;let n=e.split(`&`);for(let e of n){let[n,r]=e.split(`=`);t[n]=r}return t},r={path:`/events/:filter?`,name:`Events`,url:`app.questn.com`,maintainers:[`cxheng315`],example:`/questn/events`,parameters:{filter:`Filter string`},description:`
::: tip
