import"./esm-shims-CMsyBHYK.js";import"./config-DZMnNPig.js";import"./logger-asV68Lay.js";import"./ofetch-CRUPiVpr.js";import"./helpers-Cqaav28H.js";import{t as e}from"./parse-date-CHEO0z5G.js";import{t}from"./got-BlqYKpVp.js";const n={path:`/comic/:id`,categories:[`anime`],example:`/komiic/comic/533`,parameters:{id:`漫画 ID`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1,nsfw:!0},radar:[{source:[`komiic.com/comic/:id`],target:`/comic/:id`}],name:`漫画更新`,maintainers:[`NekoAria`],handler:r};async function r(n){let{id:r}=n.req.param(),{limit:i=0}=n.req.query(),a=`https://komiic.com`,{data:o}=await t.post(`${a}/api/query`,{json:{operationName:`comicById`,variables:{comicId:r},query:`query comicById($comicId: ID!) {
