import"./esm-shims-BKVRry6h.mjs";import"./config-uQhBoCds.mjs";import"./logger-DQf7gybc.mjs";import"./ofetch-7N8fmlQ6.mjs";import"./helpers-C6Jountz.mjs";import{t as e}from"./parse-date-C2HciIa2.mjs";import{t}from"./got-DcbI0XpN.mjs";const n={path:`/comic/:id`,categories:[`anime`],example:`/komiic/comic/533`,parameters:{id:`漫画 ID`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1,nsfw:!0},radar:[{source:[`komiic.com/comic/:id`],target:`/comic/:id`}],name:`漫画更新`,maintainers:[`NekoAria`],handler:r};async function r(n){let{id:r}=n.req.param(),{limit:i=0}=n.req.query(),a=`https://komiic.com`,{data:o}=await t.post(`${a}/api/query`,{json:{operationName:`comicById`,variables:{comicId:r},query:`query comicById($comicId: ID!) {
