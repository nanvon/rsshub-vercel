import{__dirname as e,init_esm_shims as t}from"./esm-shims-DtWyl6zt.js";import{config as n}from"./config-CT-9jq-j.js";import"./logger-BsClR5PH.js";import"./dist-BrnquCU2.js";import"./helpers-DzX-lcQO.js";import{cache_default as r}from"./cache-DNP0KCHb.js";import{art as i}from"./render-sowsPyZZ.js";import{parseDate as a}from"./parse-date-Bgabdhlb.js";import"./ofetch-Of9UBhau.js";import{got_default as o}from"./got-Cw3q2eEq.js";import{timezone as s}from"./timezone-BrNu6iXe.js";import{ConfigNotFoundError as c}from"./config-not-found-2m672-Jl.js";import l from"node:path";import{load as u}from"cheerio";import d from"p-map";t();const f=new Set([`52bdys.com`,`bde4.icu`,`bdys01.com`]),p={path:`/:caty?/:type?/:area?/:year?/:order?`,categories:[`multimedia`],example:`/bdys`,parameters:{caty:"影视类型，见下表，默认为 `all` 即不限",type:"资源分类，见下表，默认为 `all` 即不限",area:"制片地区，见下表，默认为 `all` 即不限",year:"上映时间，此处填写年份不小于2000，默认为 `all` 即不限",order:`影视排序，见下表，默认为更新时间`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!0,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`首页`,maintainers:[`nczitzk`],handler:m,description:`#### 资源分类
