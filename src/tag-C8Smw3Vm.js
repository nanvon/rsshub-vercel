import"./esm-shims-BmHUa0Yk.js";import{config as e}from"./config-CVBRPN4O.js";import"./logger-BvonkID1.js";import"./ofetch-DCfHHxuQ.js";import"./helpers-gUVC02jt.js";import{parseDate as t}from"./parse-date-DHsdom8D.js";import{got_default as n}from"./got-D5TEN1xL.js";import{config_not_found_default as r}from"./config-not-found-mNOcOzCd.js";import{load as i}from"cheerio";import{JSDOM as a}from"jsdom";const o={path:`/tag/:name?/:type?`,categories:[`social-media`],example:`/lofter/tag/cosplay/date`,parameters:{name:"tag name, such as `名侦探柯南`, `摄影` by default",type:`ranking type, see below, new by default`},features:{requireConfig:[{name:`LOFTER_COOKIE`,description:`LOFTER_COOKIE: 用于搜索标签相关内容，获取方式：
