import"./esm-shims-wKwH419_.js";import{config as e}from"./config-CCdhzIDL.js";import"./logger-tpjCqWRm.js";import"./dist-CTnfpkZH.js";import{cache_default as t}from"./cache-BqH0BkVy.js";import"./render-CxhTJIsl.js";import"./parse-date-Bgabdhlb.js";import{ofetch_default as n}from"./ofetch-CeSje37P.js";import"./not-found-CRS5K6wf.js";import{renderDescription as r}from"./utils-CL83f6fB.js";const i={path:`/charts/:category?/:country?/:embed?`,categories:[`social-media`],example:`/youtube/charts`,parameters:{category:"Chart, see table below, default to `TopVideos`",country:`Country Code, see table below, default to global`,embed:`Default to embed the video, set to any value to disable embedding`},name:`Music Charts`,maintainers:[`TonyRL`],handler:a,description:`Chart
