import"./esm-shims-BFmOnnpb.js";import"./config-CVBRPN4O.js";import"./logger-BvonkID1.js";import"./ofetch-am9EnuPq.js";import"./cache-Dfid4xgQ.js";import"./render-CSnicFA3.js";import"./parse-date-DHsdom8D.js";import{ViewType as e}from"./types-Bi82qguM.js";import{baseUrl as t,getData as n,getList as r,variables as i}from"./utils-Bo_mNjXl.js";const a={path:`/popular/:innerSharedContent?/:dateSort?`,example:`/daily/popular`,view:e.Articles,radar:[{source:[`app.daily.dev/popular`]}],parameters:{innerSharedContent:{description:`Where to Fetch inner Shared Posts instead of original`,default:`false`,options:[{value:`false`,label:`False`},{value:`true`,label:`True`}]},dateSort:{description:`Sort posts by publication date instead of popularity`,default:`true`,options:[{value:`false`,label:`False`},{value:`true`,label:`True`}]}},name:`Popular`,maintainers:[`Rjnishant530`],handler:o,url:`app.daily.dev/popular`};async function o(e){let a=`${t}/posts`,o=e.req.query(`limit`)?Number.parseInt(e.req.query(`limit`),10):15,s=e.req.param(`innerSharedContent`)?JSON.parse(e.req.param(`innerSharedContent`)):!1,c=e.req.param(`dateSort`)?JSON.parse(e.req.param(`dateSort`)):!0,l=await n({query:`
  query AnonymousFeed(
