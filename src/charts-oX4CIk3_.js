import"./esm-shims-DtWyl6zt.js";import{config as e}from"./config-BpwDbAkH.js";import"./logger-B3QfaIfn.js";import"./dist-CKN2M7CD.js";import{cache_default as t}from"./cache-BWStd97H.js";import"./render-CxhTJIsl.js";import"./parse-date-Bgabdhlb.js";import{ofetch_default as n}from"./ofetch-CYKAhM9L.js";import"./not-found-CRS5K6wf.js";import{renderDescription as r}from"./utils-oRrYDXEb.js";const i={path:`/charts/:category?/:country?/:embed?`,categories:[`social-media`],example:`/youtube/charts`,parameters:{category:"Chart, see table below, default to `TopVideos`",country:`Country Code, see table below, default to global`,embed:`Default to embed the video, set to any value to disable embedding`},name:`Music Charts`,maintainers:[`TonyRL`],handler:a,description:`Chart
