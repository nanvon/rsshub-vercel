import"./esm-shims-D5mxTuu_.mjs";import"./config-CDM38Tpk.mjs";import"./logger-B0B1yUZ6.mjs";import"./ofetch-FkpIOIxH.mjs";import"./helpers-CMl_ndRq.mjs";import{t as e}from"./cache-C6z2tE2n.mjs";import{t}from"./parse-date-Cv8vEJfE.mjs";import{t as n}from"./got-CxBlPaz_.mjs";import{n as r,t as i}from"./utils-Dk2Cnuhh.mjs";import*as a from"cheerio";const o={path:`/:id/:type?/:search?`,categories:[`multimedia`],example:`/t66y/20/2`,parameters:{id:`分区 id, 可在分区页 URL 中找到`,type:`类型 id, 可在分区类型过滤后的 URL 中找到`,search:"主题类型筛选，可在分区主题类型筛选后的 URL 中找到，默认为 `today`"},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!0,supportBT:!1,supportPodcast:!1,supportScihub:!1,nsfw:!0},name:`分区帖子`,maintainers:[`zhboner`],handler:l,description:`> 注意：并非所有的分区都有子类型，可以参考成人文学交流区的 \`古典武侠\` 这一子类型。
