import"./esm-shims-CGUM9TC6.js";import"./config-C9m9eBw5.js";import"./logger-CC3afzWM.js";import{parseDate as e}from"./parse-date-D4osZfpm.js";import"./dist-0j_z2rfc.js";import"./helpers-nWIDkd0K.js";import{cache_default as t}from"./cache-GwMhal7i.js";import"./ofetch-ZUQ1sEMc.js";import{got_default as n}from"./got-CB83B8oA.js";import{load as r}from"cheerio";const i=async i=>{let{id:a=`9`}=i.req.param(),o=i.req.query(`limit`)?Number.parseInt(i.req.query(`limit`),10):20,s=`http://www.cisia.org`,c=new URL(`site/term/${a}.html`,s).href,{data:l}=await n(c),u=r(l),d=u(`ul.list_first li`).slice(0,o).toArray().map(t=>{t=u(t);let n=t.find(`a`);return{title:n.text(),pubDate:e(t.find(`span.time`).text()),link:new URL(n.prop(`href`),s).href}});d=await Promise.all(d.map(i=>t.tryGet(i.link,async()=>{if(!/^https?:\/\/www\.cisia\.org(\/[^\s]*)?$/.test(i.link))return i;let{data:t}=await n(i.link),a=r(t),o=a(`div.TextTitle`).text(),s=a(`div.NewsText`).html(),c=a(`div.shar`).text().match(/(\d{4}-\d{2}-\d{2})/)?.[1];return i.title=o,i.description=s,i.pubDate=c?e(c):i.pubDate,i.author=a(`meta[name="Description"]`).prop(`content`),i.content={html:s,text:a(`div.NewsText`).text()},i})));let f=new URL(u(`div.logo img`).prop(`src`),s).href;return{title:u(`title`).text(),description:u(`meta[name="Description"]`).prop(`content`),link:c,item:d,allowEmpty:!0,image:f,author:u(`meta[name="Keywords"]`).prop(`content`)}},a={path:`/:id?`,name:`栏目`,url:`www.cisia.org`,maintainers:[`nczitzk`],handler:i,example:`/cisia/9`,parameters:{id:"栏目 id，默认为 `9`，即协会动态，可在对应分类页 URL 中找到"},description:`::: tip
