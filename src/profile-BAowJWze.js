import"./esm-shims-Dqvxr0BZ.js";import"./config-BpwDbAkH.js";import"./logger-B3QfaIfn.js";import{ofetch_default as e}from"./ofetch-TsvCL7Kz.js";import{parseDate as t}from"./parse-date-DHsdom8D.js";const n={path:`/profile/:handle`,name:`Link3 Profile`,url:`link3.to`,maintainers:[`cxheng315`],example:`/link3/profile/synfutures_defi`,parameters:{handle:`Profile handle`},categories:[`other`],features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`link3.to/:handle`],target:`/:handle`}],handler:r};async function r(n){let r=n.req.param(`handle`),i=await e(`https://api.cyberconnect.dev/profile/`,{method:`POST`,headers:{"Content-Type":`application/json`},body:{variables:{handle:r},query:`
            ...
            `}}),a=i.data.profile.status;if(a!==`SUCCESS`)return{title:`Error`,description:`Profile not found`,items:[{title:`Error`,description:`Profile not found`,link:`https://link3.to/${r}`}]};let o=i.data.profile.data,s=o.blocks.filter(e=>e.__typename===`EventBlock`).flatMap(e=>e.events).map(e=>({title:e.title,link:`https://link3.to/e/${e.id}`,description:e.info??``,author:o.handle,guid:e.id,pubDate:e.startTimestamp?t(e.startTimestamp*1e3):null,itunes_item_image:e.posterUrl,itunes_duration:e.endTimestamp-e.startTimestamp}));return{title:o.displayName??o.personalDisplayName.displayName,link:`https://link3.to/${o.handle}`,description:o.bio,logo:o.profilePicture??o.personalProfilePicture.picture,image:o.profilePicture??o.personalProfilePicture.picture,author:o.handle,item:s&&s.length>0?s:[{title:`No events`,description:`No events`,link:`https://link3.to/${r}`}]}}export{n as route};